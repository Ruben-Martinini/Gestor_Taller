<!--Inicio de form Carga-->
<section class="marco-principal">

<form class="row g-3 cont-form-insert" action="resultUpdateCarga.php?id=<?php echo $id; ?>&ocom=<?php echo $oc; ?>&cantA=<?php echo $can; ?>"  method="POST">
...
data-bs-target="#exampleModal" id="botonMarcaModelo" disabled>
  ...
  <div class="col-6 col-sm-9 col-xl-10">
    <button type="submit" name="submitAlta" class="btn btn-primary">Cargar</button>
  </div>
