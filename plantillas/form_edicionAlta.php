...
<form class="row g-3 cont-form-insert" action="resultUpdateAlta.php?id=<?php echo $id; ?>&ma=<?php echo $mar; ?>&pol=<?php echo serialize($Po); ?>&mer=<?php echo serialize($Me); ?>&hon=<?php echo serialize($Ho); ?>&ocom=<?php echo $oc; ?>"  method="POST">
...
data-bs-target="#exampleModal" id="botonMarcaModelo" >
  ...
  <div class="col-4 col-sm-3 col-xl-2">
    ...
    <input type="text" class="form-control" name="ubica" id="inputUbicacion" placeholder="Coordenadas" value="<?php echo $ubc; ?>" >
  </div>
  ...
  <div class="col-4 col-sm-6 col-xl-7">    
    <input type="text" class="form-control" name="FormaAdquisicion" id="inputFormaAdquisicion" value="<?php echo $oc; ?>" > 
  </div>

  <div class="col-6 col-sm-9 col-xl-10">
    <button type="submit" name="submitAlta" class="btn btn-primary">Editar</button>
  </div>

  <div class="col-6 col-sm-3 col-xl-2">   
    <input type="number" class="form-control" name="cantidad" id="inputCantidad" placeholder="Cantidad" value="<?php echo $can; ?>">
  </div>
