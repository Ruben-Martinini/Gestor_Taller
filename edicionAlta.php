...
$Po=unserialize($_GET['pol']);
$Me=unserialize($_GET['mer']);
$Ho=unserialize($_GET['hon']);
...
<body>
   ...
   <?php include 'plantillas/form_edicionAlta.php'; ?>
