...
/* if ($_REQUEST['inlineRadioOptions']=="Mercury")
 {
   
   echo "Mercury";
 } else {
 if($_REQUEST['inlineRadioOptions']=="Polaris")
 {
...
if(!isset($row1['nro_parte'] )&& !isset($row1['aplicacion'])&& !isset($row1['designacion'])&&!isset($row1['ubicacion'])){
